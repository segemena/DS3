...
generate_complete_trace = False                                                 # This flag is set by generate_traces.py, do not modify
DVFS_cfg_list = []                                                              # This flag is set by generate_traces.py, do not modify
num_PEs_TRACE = 0                                                               # This flag is set by generate_traces.py, do not modify
trace_file_num = 0                                                              # This flag is set by generate_traces.py, do not modify
gen_trace_capacity_little = -1                                                  # This flag is set by generate_traces.py, do not modify
gen_trace_capacity_big = -1                                                     # This flag is set by generate_traces.py, do not modify
sim_ID = 0
...
scale_values_list = str_to_list(config['SIMULATION MODE']['scale_values'])      # List of scale values which will determine the job arrival rate under performance mode
job_list = str_to_list(config['SIMULATION MODE']['job_list'])                   # List containing the number of jobs that should be executed for each application
if len(job_list) > 0:
